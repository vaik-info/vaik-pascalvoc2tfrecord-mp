...
def pascal_voc2tf_example(image_path, xml_path, classes, random_quality=(90, 100)):
    ...
    tf_example = tf.train.Example(features=tf.train.Features(feature={
        ...
        'image/object/bbox/xmin': float_list_feature(x_min_array.stack()),
        'image/object/bbox/xmax': float_list_feature(x_max_array.stack()),
        'image/object/bbox/ymin': float_list_feature(y_min_array.stack()),
        'image/object/bbox/ymax': float_list_feature(y_max_array.stack()),
